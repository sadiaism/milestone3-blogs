...
const Blog = ({ params }: { params: Params }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-slate-300 pb-[12px]">
      <Image
        ...
        height={300}
      />
      <p className="text-[32px] font-bold">{blogItem.title}</p>
      <p className="flex text-center p-[32px] text-[20px] font-semibold">{blogItem.description}</p>
      <p className="text-[20px] font-semibold pb-[44px]">
